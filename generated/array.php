 ...
 * 
 */
function array_walk_recursive( &$array, callable $callback,  $userdata = null): void
{
    error_clear_last();
 ...
 * @param int $flags You may modify the behavior of the sort using the optional parameter
 * flags, for details see
 * sort.
 * @throws ArrayException
 * 
 */
 ...
 * 
 * @param array $array The input array.
 * @param int $flags You may modify the behavior of the sort using the optional
 * parameter flags, for details
 * see sort.
 * @throws ArrayException
 * 
 */
 ...
 * @param array $array The input array.
 * @param int $flags You may modify the behavior of the sort using the optional
 * parameter flags, for details see
 * sort.
 * @throws ArrayException
 * 
 */
 ...
 * 
 * @param array $array The input array.
 * @param callable $callback See usort and uksort for
