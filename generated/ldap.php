 ...
 * 
 */
function ldap_add( $ldap, string $dn, array $entry,  $controls = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_bind( $ldap,  $dn = null,  $password = null): void
{
    error_clear_last();
 ...
 * 
 */
function ldap_free_result( $ldap): void
{
    error_clear_last();
    $result = \ldap_free_result($ldap);
    if ($result === false) {
        throw LdapException::createFromPhpError();
    }
}
 ...
 * 
 * 
 * @param  $value This will be set to the option value.
 * @throws LdapException
 * 
 */
 ...
 * @param string $matched_dn A reference to a variable that will be set to a matched DN if one was
 * recognised within the request, otherwise it will be set to NULL.
 * @param string $error_message A reference to a variable that will be set to the LDAP error message in
 ...
 * 
 */
function ldap_sasl_bind( $ldap,  $dn = null, string $password = null,  $mech = null,  $realm = null,  $authc_id = null,  $authz_id = null, string $props = null): void
{
    error_clear_last();
 ...
 * 
 * @param  $ldap An LDAP link identifier, returned by ldap_connect.
 * @param int $option The parameter option can be one of:
 * 
 * 
 * 
